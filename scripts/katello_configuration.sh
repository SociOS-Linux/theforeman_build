#!/bin/bash
#Creating Organization and location
...
#Creating product and repositories
...
#Creating Lifecycle environment
...
#Creating activation key and subscription
